...
namespace Lemoo_pos.Migrations
{
    ...
    [Migration("20241201010405_update-relationship-inventory-product-variant-2")]
    partial class updaterelationshipinventoryproductvariant2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lemoo_pos.Models.Entities.ProductVariant", b =>
                {
                    b.HasOne("Lemoo_pos.Models.Entities.Inventory", "Inventory")
                        ...
                        .HasForeignKey("Lemoo_pos.Models.Entities.ProductVariant", "InventoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
